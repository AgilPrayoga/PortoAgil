    ...
    return(
       <div>
        ...
        <div className="m-4">
                ...
                >Sobat Loker is a college project website. <br /> <a className="text-[#d5ceb6] font-montserrat w-fit hover:text-[#2C3333] hover:bg-[#d5ceb6]">The main idea</a> is to create a website for looking for jobs <br />,that has 2 perspectives from job seekers and job employers. </m.p>
